  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <footer className="border-t border-white/20 bg-gradient-to-r from-slate-50 via-blue-50 to-indigo-100 backdrop-blur-sm">
          <div className="flex flex-row mx-auto max-w-7xl px-6 py-12 md:flex md:items-start md:justify-between ">
            ...
            <div className="mb-4">
              <p className="text-sm text-slate-500 justify">
                Built with{" "}
                <a
